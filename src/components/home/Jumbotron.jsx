  ...
  return (
    <Container className="">
      <Inner>
        <TextDiv>
          <ColoredSpan>
            House Of Delicacy is a premier food distribution corporation offering good food distribution to our customers, and
            Ensuring you get what you need on time...
          </ColoredSpan>
          <Text
        ...
        <BtnDiv>
          <Link to={"/product"} onClick={scrollToTop}>
            <StyledButton size="large">Our Items</StyledButton>
          ...
          <Link to={"/services"} onClick={scrollToTop}>
            {" "}
            <StyledButton size="large"> Our services</StyledButton>
          </Link>
        </BtnDiv>
      </Inner>
    </Container>
